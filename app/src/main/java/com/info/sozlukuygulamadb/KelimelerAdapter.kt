...
class KelimelerAdapter(private val mathContext:Context, private val kelimelerListe:List<Kelimeler>)
    ...
    inner class CardTasarimTutucu(tasarim:View) : RecyclerView.ViewHolder(tasarim) {
        ...
        init {
            ...
            textViewIngilizce = tasarim.findViewById(R.id.textViewIngilizces)
            textViewTurkce = tasarim.findViewById(R.id.textViewTurkce)
        }
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CardTasarimTutucu {
        val tasarim = LayoutInflater.from(mathContext).inflate(R.layout.card_tasarim, parent, false)
    ...
    override fun onBindViewHolder(holder: CardTasarimTutucu, position: Int) {
        ...
        holder.kelime_card.setOnClickListener {
            ...
            val intent  = Intent(mathContext, DetayActivity::class.java)

            intent.putExtra("nesne", kelime)

            mathContext.startActivity(intent)
